...
export const getDiaries = asyncHandler(async (req, res) => {
  ...
  const apiFeaturesForFilter = new ApiFeatures(baseQuery, req.query).filter(); // Apply filtering
...
// @access  Private
export const getDiaryById = asyncHandler(async (req, res, next) => {
...
// @access  Private
export const createDiary = asyncHandler(async (req, res, next) => {
  const {
    date,
    caloriesIntake,
    energyLevel,
...
// @access  Private
export const updateDiary = asyncHandler(async (req, res, next) => {
  const diary = await Diary.findById(req.params.id);
...
// @access  Private
export const deleteDiary = asyncHandler(async (req, res, next) => {
  const diary = await Diary.findById(req.params.id);
